...
export class ParallaxHeaderDirective {
  ...
  ngOnInit() 
  {
    ...
    this.header = content.getElementsByClassName("parallaxImage")[0];
  ...
  {   
    ...
    this.domCtrl.write(() => {
        ...
        this.renderer.setStyle(this.header, 'webkitTransform', 'translate3d(0,' + this.moveImage + 'px, 0) scale(' + this.scaleImage + ',' + this.scaleImage + ')');
    });
  }
